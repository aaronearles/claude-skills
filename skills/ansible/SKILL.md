...
name: ansible
description: >
  Organizational standards and best practices for Ansible playbook and role development.
  Use this skill whenever writing, reviewing, scaffolding, or refactoring any Ansible code —
  including playbooks, roles, tasks, handlers, templates, inventory files, or group/host vars.
  Also use for variable management, Ansible Vault secrets, Molecule testing, idempotency,
  YAML formatting, ansible-lint compliance, or creating new Ansible projects or roles.
---

# Ansible Development Standards

This document outlines the standards and best practices for Ansible playbook and role development.
